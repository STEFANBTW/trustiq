...
import { LogIn, Mail, Lock, ArrowRight, Chrome, Apple } from 'lucide-react';
      ...
      >
        <div className="text-center space-y-4 mb-10">
          ...
          <p className="text-sm text-text-secondary font-medium">
            Access your premium beverage allocations.
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center px-4">
              ...
              <button type="button" className="text-xs font-black uppercase tracking-widest text-accent hover:underline">Forgot?</button>
            </div>
            <div className="relative">
        ...
        <div className="mt-10 space-y-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs font-black uppercase tracking-widest">
              <span className="bg-bg-secondary px-4 text-text-secondary">Or Continue With</span>
            </div>
          </div>
